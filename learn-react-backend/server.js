...
// // -----------------------------
// // Ensure extra tables exist (likes/comments/shares + comment_likes + parent_id)
// // -----------------------------
// (async () => {
//   try {
//     await pool.query(`
...
//     // Get all comments for the post with user info + like counts + liked_by_me
//     const q = `
//       SELECT
...
// // Edit / Delete post remain unchanged (kept from your original file)...
...
// -----------------------------
// Ensure extra tables exist (likes/comments/shares + comment_likes + parent_id + reports + follows)
// -----------------------------
(async () => {
  try {
    await pool.query(`
